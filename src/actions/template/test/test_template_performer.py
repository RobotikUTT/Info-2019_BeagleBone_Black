...
class TestTemplatePerformer(unittest.TestCase):
	def setUp(self):
		# Init some position
	...
	def test_action_point(self):
		"""
			Test action point computation for template performer.
		"""
		# Create move action
		action = Action.parse_string("<template />")
...
if __name__ == '__main__':
	rospy.init_node('test_template_performer', anonymous=True)
	rostest.rosrun('template', 'actions', TestTemplatePerformer, sys.argv)
