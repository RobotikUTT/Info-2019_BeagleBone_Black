 ...
 * 
 */
Controller::Controller(ros::NodeHandle *n) : acM("/procedures/move_action", true)
{
  //attributes
  nh = *n;
  side = SIDE_GREEN;
...
void Controller::SetAction()
{
  ...
  if (action_val == MOVE)
  {
    ...
    acM.sendGoal(goal, boost::bind(&Controller::onActionDone<MoveResultConstPtr>, this, _1, _2));
